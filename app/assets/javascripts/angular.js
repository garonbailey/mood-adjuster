	...
	controller.search = function () {
		...
		if (action === "Reinforce My Mood") {
			if (mood === "Surprise") {
				...
				$http({
					method: 'GET',
					url: "https://api.giphy.com/v1/gifs/search?q=" + mood + "&api_key=dc6zaTOxFJmzC"
				}).then(function success(res) {
			...
			if (mood === "Sad") {
				$http({
					method: 'GET',
					url: "https://api.giphy.com/v1/gifs/search?q=happy&api_key=dc6zaTOxFJmzC"
				}).then(function success(res) {
					controller.gifUrl = res.data.data[Math.floor(Math.random()*25)].images.original.url;
				...
				$http({
					method: 'GET',
					url: "https://api.giphy.com/v1/gifs/search?q=miserable&api_key=dc6zaTOxFJmzC"
				}).then(function success(res) {
					controller.gifUrl = res.data.data[Math.floor(Math.random()*25)].images.original.url;
				...
				$http({
					method: 'GET',
					url: "https://api.giphy.com/v1/gifs/search?q=peaceful&api_key=dc6zaTOxFJmzC"
				}).then(function success(res) {
					controller.gifUrl = res.data.data[Math.floor(Math.random()*25)].images.original.url;
				...
				$http({
					method: 'GET',
					url: "https://api.giphy.com/v1/gifs/search?q=upset&api_key=dc6zaTOxFJmzC"
				}).then(function success(res) {
					controller.gifUrl = res.data.data[Math.floor(Math.random()*25)].images.original.url;
				...
				$http({
					method: 'GET',
					url: "https://api.giphy.com/v1/gifs/search?q=calm&api_key=dc6zaTOxFJmzC"
				}).then(function success(res) {
					controller.gifUrl = res.data.data[Math.floor(Math.random()*25)].images.original.url;
				...
				$http({
					method: 'GET',
					url: "https://api.giphy.com/v1/gifs/search?q=laid-back&api_key=dc6zaTOxFJmzC"
				}).then(function success(res) {
					controller.gifUrl = res.data.data[Math.floor(Math.random()*25)].images.original.url;
				...
				$http({
					method: 'GET',
					url: "https://api.giphy.com/v1/gifs/search?q=pleased&api_key=dc6zaTOxFJmzC"
				}).then(function success(res) {
					controller.gifUrl = res.data.data[Math.floor(Math.random()*25)].images.original.url;
				...
				$http({
					method: 'GET',
					url: "https://api.giphy.com/v1/gifs/search?q=agitated&api_key=dc6zaTOxFJmzC"
				}).then(function success(res) {
					controller.gifUrl = res.data.data[Math.floor(Math.random()*25)].images.original.url;
				...
				$http({
					method: 'GET',
					url: "https://api.giphy.com/v1/gifs/search?q=tense&api_key=dc6zaTOxFJmzC"
				}).then(function success(res) {
					controller.gifUrl = res.data.data[Math.floor(Math.random()*25)].images.original.url;
